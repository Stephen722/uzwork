	...
	<form id="audit-form" name="audit-form" action="<%=path%>/uzwork-admin-center/user-mag?process=auditUserInfo" enctype="multipart/form-data" method="post">
		<div class="user-audit">
			<div class="headerline">
				...
				<p><br/><span>审核详情</span><br/><br/>
			     <span style="display:-moz-inline-box; display:inline-block;width:70px">审核人</span> <span> <input type="text" name="adminId" readOnly="true" value="${userReview.adminUserName}"/></span>
			     <span style="display:-moz-inline-box; display:inline-block;width:70px">审核结果</span> <span> <input type="text" name="qualified" readOnly="true" value="${user.status.name}"/></span>
			     <br/>
			     <br/>
			     <span style="display:-moz-inline-box; display:inline-block;width:70px">提交时间</span> <span> <input type="text" name="createdTime" readOnly="true" value="${userReview.createdTime}"/></span>
			     <span style="display:-moz-inline-box; display:inline-block;width:70px">审核时间</span> <span> <input type="text" name="reviewedTime" readOnly="true" value="${userReview.reviewedTime}"/></span>
			     <c:if test="${not empty userReview.review}">
			     <p>
			     <span>未通过原因</span>
			      <br/>
			      <textarea id="review" name="review">${userReview.review}</textarea>
			      </p>
			     </c:if>
			    </p>
			</div>
